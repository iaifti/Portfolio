...
const experiences = [
  {
    ...
    period: "Present",
    bullets: [
      "Design and develop full-stack features for ProSync, spanning Next.js frontend applications, backend services, APIs, and data-layer integrations.",
      "Build and maintain REST APIs and data pipelines that support application workflows, system integrations, and reliable data movement across services.",
      "Collaborate across engineering and product teams to architect, implement, and optimize production-ready solutions with a focus on scalability, reliability, and maintainability.",
      "Contribute to cloud infrastructure, CI/CD pipelines, deployment automation, and DevOps practices to improve application delivery and operational reliability.",
    ],
  },
      ...
      <div style={{ marginBottom: "4rem" }}>
        ...
        >
          ...
          <span
            style={{
              color: "transparent",
              WebkitTextStroke: "2px rgba(245,158,11,0.35)",
            }}
          >
            Experience
          </span>
            ...
            <div style={{ marginBottom: "1.25rem" }}>
              ...
              >
                ...
                {exp.period && (
                  <>
                    <span
                      style={{ color: "rgba(245,158,11,0.2)", fontSize: 10 }}
                    >
                      ·
                    </span>
                    <span
