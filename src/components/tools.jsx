...
const sections = [
  {
    ...
    desc: "Tools and technologies I use for software development, including web applications and full-stack engineering.",
    tools: softwareEngineeringTools,
  },
  {
    label: "Data Engineering",
    eyebrow: "Data Stack",
    desc: "Technologies and platforms I use to design scalable pipelines, process large datasets, and deliver reliable analytics systems.",
    tools: dataEngineeringTools,
  },
  {
    label: "Version Control & DB",
    eyebrow: "Foundations",
    desc: "Tools essential to both data engineering and software development workflows — from source control to database management.",
    tools: versionControlAndDatabaseTools,
  },
];
    ...
    >
      ...
      >
        <img
          ...
          style={{
            ...
            height: 24,
            filter: hovered
              ? "invert(1) sepia(1) saturate(2) hue-rotate(5deg)"
              : "invert(0.7) sepia(0.3) saturate(0.5)",
            transition: "all 0.2s ease",
          }}
        />
      </div>
      <span
        style={{
          ...
          color: hovered ? "rgba(245,158,11,0.9)" : "rgba(255,220,100,0.3)",
          textAlign: "center",
          lineHeight: 1.3,
