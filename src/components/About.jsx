...
const About = () => {
  ...
  <section id="about" className="py-20 font-nunito bg-navy bg-opacity-20">
    ...
    <p className="max-w-4xl mx-auto text-2xl leading-10 text-gray-700">
      ...
      <br />
      <br />
      My portfolio showcases a blend of creativity and technical expertise, with a commitment to providing 
      impactful, data-driven results. I also co-founded a company offering software development services 
      on a contract basis, combining my technical foundation with an entrepreneurial mindset.
      <br />
      <br />
